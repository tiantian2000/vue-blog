  ...
  <div class="note-editor">
    ...
    <div class="logform">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="主题图片" prop="photo">
          <el-upload
            name="photo"
            ...
            <img v-if="imageUrl" :src="'http://localhost:9090/blog/'+imageUrl" class="avatar">
    ...
    data(){
      return {
        ...
        rules: {
          ...
          //photo:[{required: true, message: '请上传标题图片', trigger: 'blur'}]
        }
    ...
    methods:{
      onSubmit(formName){
          this.$refs[formName].validate((valid) => {
            if (valid) {
              //从localStorage中取出用户名
              this.form.author = sessionStorage.getItem('currentUser_name')
              this.$ajax.post('/addArticle', this.form).then(response => {
                this.$message({
                  message: '提交成功',
                  type: 'success'
                });
